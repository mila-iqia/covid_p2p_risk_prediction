...
class Metrics(nn.Module):
    ...
    def update(self, model_input, model_output):
        ...
        diff = model_output.latent_variable[:, :, 0:1].view(-1) - model_input.infectiousness_history.view(-1)
        ...
        prediction = model_output.encounter_variables.squeeze(2).masked_fill((1 - model_input.mask).bool(), -float('inf'))
    ...
    def evaluate(self):
        return dict([('mse', math.sqrt(self.total_infectiousness_loss / (self.total_infectiousness_count + 0.001))), 
